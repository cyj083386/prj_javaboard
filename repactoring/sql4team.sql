...
load data local infile 'C:\\data3.txt' into table sigugun fields terminated BY '\t' lines terminated by '\n';
...
-- ALTER TABLE nonuser ADD PRIMARY KEY(non_cp); 이waybill미 기본키(pk) 설정되어있음
